        ...
        <div className="laptop:mt-20 mt-10">
          <div className="flex flex-row gap-10">
            <div className="mt-5">
              ...
              <h1
                ref={textFour}
                className="text-2xl tablet:text-3xl laptop:text-4xl laptopl:text-5xl p-1 tablet:p-2 text-bold w-full laptop:w-4/5"
              >
                {data.headerTaglineFour}
              </h1>
            </div>
            <div
              className="rounded-full border-4 border-slate-200 w-96 h-96 bg-cover bg-center"
